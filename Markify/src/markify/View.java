...
import markify.constants.KidFriendlyStatus;
import markify.constants.UserType;
import markify.controllers.BookmarkController;
import markify.entities.Bookmark;
import markify.entities.User;
import markify.partner.Shareable;
...
public class View {
	...
	// TODO: Below methods simulate user input. Input via console needs to implemented.
	 ...
	 * System.out.println("\n" + user.getEmail() + " has bookmarked"); for (int i =
